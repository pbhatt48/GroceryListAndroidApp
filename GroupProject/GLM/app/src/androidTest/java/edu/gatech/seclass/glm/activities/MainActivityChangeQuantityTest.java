...
public class MainActivityChangeQuantityTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void mainActivityChangeQuantityTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.text), withText("Pepper"),
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(android.R.id.button1), withText("Change Quantity"),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.text), withText("Pepper"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Pepper")));
